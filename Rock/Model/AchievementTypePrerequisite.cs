...
namespace Rock.Model
{
    ...
    public partial class AchievementTypePrerequisite : Model<AchievementTypePrerequisite>, ICacheable
    {
        ...
        /// <summary>
        /// Gets or sets the Id of the <see cref="Model.AchievementType"/> to which this prerequisite belongs. This property is required.
        /// </summary>
        [Required]
        ...
        /// <summary>
        /// Gets or sets the Id of the <see cref="Model.AchievementType"/> that is the prerequisite. This property is required.
        /// </summary>
        [Required]
        [DataMember( IsRequired = true )]
        ...
        /// <summary>
        /// Gets or sets the PrerequisiteAchievementType.
        /// </summary>
        [DataMember]
        ...
        public override bool IsValid
        {
            get
            {
                ...
                {
                    ValidationResults.Add( new ValidationResult( "AchievementTypeId cannot be equal to PrerequisiteAchievementTypeId" ) );
                    isValid = false;
                }
