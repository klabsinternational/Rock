...
namespace Rock.Model
{
    ...
    public partial class StreakService : Service<Streak>
    {
        ...
        public bool CanDelete( Streak item, out string errorMessage )
        {
            ...
            if ( new Service<AchievementAttempt>( Context ).Queryable().Any( a => a.AchieverEntityId == item.Id ) )
            {
                errorMessage = string.Format( "This {0} is assigned to a {1}.", Streak.FriendlyTypeName, AchievementAttempt.FriendlyTypeName );
                return false;
            }  
            return true;
        }
