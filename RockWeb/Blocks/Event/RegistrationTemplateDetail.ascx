        ...
        <Rock:ModalDialog ID="dlgDiscount" runat="server" Title="Discount Code" OnSaveClick="dlgDiscount_SaveClick" OnCancelScript="clearActiveDialog();" ValidationGroup="Discount">
            <Content>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <Rock:NumberBox ID="nbDiscountMaxUsage" runat="server" NumberType="Integer" MinimumValue="0" Label="Maxium Of Registrations That Can Use The Discount"
                            Help="The maximum number of registrations that the discount code can be used on (leave blank for none)." />
                        <Rock:NumberBox ID="nbDiscountMaxRegistrants" runat="server" NumberType="Integer" MinimumValue="0" Label="Maxium Registrants Per Registration The Discount Can Apply To"
                            Help="The maximum number of registrants in a single registration that the discount code can be used on." />
                        <Rock:NumberBox ID="nbDiscountMinRegistrants" runat="server" NumberType="Integer" MinimumValue="0" Label="Minimum Registrants Required Per Registration To Use The Discount"
                            Help="The minimum number of registrants in the registration that are required in order to use this discount code." />
