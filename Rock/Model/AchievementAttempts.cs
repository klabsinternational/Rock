...
namespace Rock.Model
{
    ...
    public partial class AchievementAttempt : Model<AchievementAttempt>
    {
        ...
        /// <summary>
        /// Gets or sets the Id of the achiever entity to which this attempt belongs. This property is required.
        /// This originally was StreakId
        /// </summary>
        [Required]
        ...
        public partial class AchievementAttemptConfiguration : EntityTypeConfiguration<AchievementAttempt>
        {
            ...
            {
                HasRequired( saa => saa.AchievementType ).WithMany( s => s.AchievementAttempts ).HasForeignKey( saa => saa.AchievementTypeId ).WillCascadeOnDelete( true );
            }
        }
