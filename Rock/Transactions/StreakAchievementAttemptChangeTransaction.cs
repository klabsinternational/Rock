...
namespace Rock.Transactions
{
    ...
    {
        /// <summary>
        /// Gets the achiever identifier.
        /// </summary>
        private int AchieverEntityId { get; }

        /// <summary>
        /// Gets the achievement attempt unique identifier.
        /// </summary>
        ...
        public AchievementAttemptChangeTransaction( DbEntityEntry entry )
        {
            ...
            AchieverEntityId = achievementAttempt.AchieverEntityId;
